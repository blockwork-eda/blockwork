...
class TestTools:
    ...
    def test_tool_multiple_versions(self, tmp_path: Path) -> None:
        ...
        assert list(inst) == [Widget.versions[0], Widget.versions[1]]
    ...
    def test_tool_requirement(self, tmp_path: Path) -> None:
        ...
        class ToolB(Tool):
            versions: ClassVar[list[Version]] = [
                Version("2.1", tb_2_1, default=True, requires=[Require(ToolA, "1.1")]),
    ...
    def test_tool_bad_versions(self, tmp_path: Path) -> None:
        ...
        with pytest.raises(ToolError) as exc:
            ...
            class Widget(Tool):
                versions: ClassVar[list[Version]] = {"1.1": True}
        ...
        with pytest.raises(ToolError) as exc:
            ...
            class Widget(Tool):
                versions: ClassVar[list[Version]] = ["1.1", False]
        ...
        with pytest.raises(ToolError) as exc:
            ...
            class Widget(Tool):
                versions: ClassVar[list[Version]] = [Version(version="1.0", location="/a/b/c")]
        ...
        with pytest.raises(ToolError) as exc:
            ...
            class Widget(Tool):
                versions: ClassVar[list[Version]] = [
                    Version(version="", location=tmp_path / "widget")
                ]
        ...
        with pytest.raises(ToolError) as exc:
            ...
            class Widget(Tool):
                versions: ClassVar[list[Version]] = [
                    Version(version="1.0", location=tmp_path / "widget", default=123)
                ]
    ...
    def test_tool_bad_require(self, tmp_path: Path) -> None:
        ...
        with pytest.raises(ToolError) as exc:
            ...
            class ToolA(Tool):
                versions: ClassVar[list[Version]] = [Version(version="1.0", location=tool_loc)]
