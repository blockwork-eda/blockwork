...
| host_scratch         |                  | `../{site}.scratch` | Directory to store build objects and other artefacts                       |
| host_state           |                  | `../{site}.state`   | Directory to store Blockwork's state information for the project           |
| host_tools           |                  | `../{site}.tools`   | Directory containing tool installations on the host                        |
...
!!!note
    ...
    relative to the project's root directory on the host, and the `{site}`
...
|--------------|-------------------|----------------------------------------------------------------|
| `{site}`  | `root`, `scratch` | Name of the project (from the `project` field)                 |
